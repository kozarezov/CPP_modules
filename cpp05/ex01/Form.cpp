...
/*   Updated: 2021/01/09 21:28:33 by ceccentr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string name, int grade_by_sign, int grade_by_execute) : name(name), grade_by_sign(grade_by_sign), grade_by_execute(grade_by_execute)
{
	this->sign = false;
...
Form::Form(Form const &other) : name(other.name), grade_by_sign(other.grade_by_sign), grade_by_execute(other.grade_by_execute)
{
